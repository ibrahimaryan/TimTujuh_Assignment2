...
# Konfigurasi Wi-Fi
SSID = "Ettoo_-"   # Ganti dengan nama WiFi
PASSWORD = "Wear15@ "  # Ganti dengan password WiFi

# Konfigurasi Ubidots
TOKEN = "BBUS-eR4SKOpHmTxd4RBirCvRXtt16KpZlt"  # Ganti dengan token Anda
DEVICE_LABEL = "esp32-sic6"  # Label perangkat di Ubidots
...
SERVER_URL = "http://172.90.1.26:5000/sensor"  # Ganti dengan alamat server Anda
